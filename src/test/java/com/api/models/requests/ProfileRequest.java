...
public class ProfileRequest {
	...
	// Builder class to demonstrate Builder pattern 
	// This should be a Inner class
	// build() will create the Object of outer class
	public static class Builder {
		...
		// This will create the object of outer class
